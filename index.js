...
function sodaSong() {
    for(let i = 99; i > 1; i--) {
        console.log("You have " + i + " bottles left");
    }

}
console.log(sodaSong());
...
let numbGrade = 
function gradebook (numbGrade) {
    if (numbGrade >= 90){
        return A
    }   else if(numbGrade <= 90 && >= 80) {
        return B
    }
        else if(numbGrade < 80 && >= 70) {
        return C
    }
        else if(numbGrade < 70 && >= 60) {
        return D
