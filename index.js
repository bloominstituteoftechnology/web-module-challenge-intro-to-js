...
let dogWeight = 7;
let dogAge = 1;
let feedHim = hungryDog(dogWeight, dogAge);
console.log(feedHim);
...
function miles(kilometers){
  let newMiles = kilometers * 0.621371;
  return newMiles;
}
let kilo = 25
...
function feet(centimeters){
  let newFeet = centimeters / 30.48;
  return newFeet;
}
let centi = 10
console.log (feet(centi));
