...
function game(user, computer){
  ...
  if (user == .33 && computer == "rock"){
    return "it's a tie"
  } else if (user == .33 && computer == "paper"){
    return "you lose!"
  } else if (user == .33 && computer == "scissors"){
    return "you win!"
  } else if (user == .66 && computer == "rock"){
    return "you win!";
  } else if (user == .66 && computer == "paper"){
    return "it's a tie"
  } else if (user == .66 && computer == "scissors"){
    return "you lose!"
  } else if (user == 1 && computer == "rock"){
    return "you lose!"
  } else if (user == 1 && computer == "paper"){
    return "you win!"
  } else if (user == 1 && computer == "scissors"){
    return "it's a tie"
  }
}

console.log(game(.33, Math.random()));
