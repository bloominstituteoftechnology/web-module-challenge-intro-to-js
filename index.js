...
console.log(multiplyNumbers()); //call function
...
// //V1 (does not find all values. Values have to be called manually)
...
// function findVowels() {
//   for (let s = letters.length; s > 0; s--)
//     if (letters.includes("a", s)) {
//       vowels++;
//       letters.splice(s, 1);
//     } else if (letters.includes("A", s)) {
//       vowels++;
//       letters.splice(s, 1);
//     } else if (letters.includes("e", s)) {
//       vowels++;
//       letters.splice(s, 1);
//     } else if (letters.includes("E", s)) {
//       vowels++;
//       letters.splice(s, 1);
//     } else if (letters.includes("i", s)) {
//       vowels++;
//       letters.splice(s, 1);
//     } else if (letters.includes("I", s)) {
//       vowels++;
//       letters.splice(s, 1);
//     } else if (letters.includes("o", s)) {
//       vowels++;
//       letters.splice(s, 1);
//     } else if (letters.includes("O", s)) {
//       vowels++;
//       letters.splice(s, 1);
//     } else if (letters.includes("u", s)) {
//       vowels++;
//       letters.splice(s, 1);
//     } else if (letters.includes("U", s)) {
//       vowels++;
