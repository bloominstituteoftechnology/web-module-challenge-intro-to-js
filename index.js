...
if (votingAge >= 18) {
  console.log('task 1 a:', "Is a Voter");

} else {
  if (votingAge < 18) {
    console.log('task 1 a:',"Not a Voter") 
  }
}
...
Do the following:   
   ...
   HINT: no function required
*/
let coffeeFlavor = "French Vanilla";
const season = "fall";

if (season === "fall") {
  coffeeFlavor = 'Toasted Marshmallow Mocha';
}

console.log('task 1 b:',coffeeFlavor)
...
console.log('task 1 d:', multiply(8,6))
