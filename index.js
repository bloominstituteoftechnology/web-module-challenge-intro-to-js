...
function miles(Convert, miles){
  return (Convert*miles);
}
let kilometers= miles(1.60934,2);
...
function feet(Convert,CM){
  return (convert*CM);
}
let Centimeters= feet(30.48,10);
