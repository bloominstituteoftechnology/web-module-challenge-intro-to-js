...
function hungryDog(pounds , years){
    ...
    else if(years > .333 && years < .583){
      return pounds*.05;
    }
    else if(years > .583 && years < 1){
      return pounds*.04;
    }
    else if(years < 1 && pounds <= 5){
      return pounds*.05;
    }
    else if(years <= 1 && pounds <= 10 && pounds >= 6 ){
      return pounds*.04;
    }
    else if(years <= 1 && pounds <= 15 && pounds >= 11 ){
      return pounds*.03; 
    }
...
function annoyingSong(starting, start) {
