...
function removeLastFlavor(){
 ...
 // generically removes whatever is last//

  or 

  function removeLastFlavor(last){
    originalFlavors.pop(last);
  console.log(originalFlavors)
    
  }
  removeLastFlavor('Vanilla Burnt Almond')
// more specific//
...
function getFlavorByIndex(where){
    console.log(originalFlavors[where])
    }
